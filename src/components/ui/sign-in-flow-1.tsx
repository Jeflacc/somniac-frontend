...
function MiniNavbar() {
  ...
  return (
    <header className={cn(`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
...
export const SignInPage = ({ className, onSuccess, onBack, onSubmit, isLoading: externalLoading }: SignInPageProps) => {
  ...
  // Custom theme colors for Somniac Lab
  // Accent #3B6255 -> [59, 98, 85]
  // White -> [255, 255, 255]
  const accentColor: number[] = [59, 98, 85];
  const whiteColor: number[] = [255, 255, 255];
  ...
  return (
    <div className={cn("flex w-full flex-col min-h-screen bg-black relative overflow-hidden", className)}>
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="flex flex-1 flex-col justify-center items-center px-4 pt-32 pb-12">
              ...
              {step === "email" ? (
                ...
                >
                  <div className="space-y-1">
                    <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Somniac AI</h1>
                  ...
                  <div className="space-y-4">
                    <button className="backdrop-blur-md w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-full py-3 px-4 transition-colors">
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-3">
                      ...
                      <div className="relative">
                        ...
                        <button 
                          type="submit"
                          disabled={isLoading}
                          className="absolute right-1.5 top-1.5 text-black w-9 h-9 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors group overflow-hidden disabled:opacity-50"
                        >
                          {isLoading ? (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-[1.25rem] text-white/50 font-light">Welcome to Somniac Lab</p>
                  </div>
                  ...
                  <motion.div 
                    ...
                    className="py-10"
                  >
                    <div className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-white to-white/70 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.3)]">
